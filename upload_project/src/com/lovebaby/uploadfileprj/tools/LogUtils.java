...
/**
 * Log工具，类似android.util.Log�? * tag自动产生，格�? customTagPrefix:className.methodName(L:lineNumber),
 * customTagPrefix为空时只输出：className.methodName(L:lineNumber)�? * <p/>
 */
public class LogUtils {
    ...
    public static String  TAG = "UploadFilePrj";
    ...
    public static void d(String content) {
        if (!UploadConstant.isDebug) return;
    ...
    public static void i(String content) {
        ...
        if (customLogger != null) {
            ...
            for (int i = 0; i < 100; i++) {//解决log打印的内容超过Log上限的问�? 
                if (strLength > end) {  
